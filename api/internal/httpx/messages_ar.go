...
const (
	...
	MsgCustomFieldSensitiveAutocomplete = "لا يجوز وسم حقل الإكمال التلقائي بأنه سري. الحقول السرية تخص النص الحر فقط."
	...
	// Field suggestions (type-ahead on the search filters)
	MsgSuggestionFieldRequired = "حدّد حقلًا واحدًا فقط لجلب الاقتراحات."
	MsgSuggestionCheckboxField = "حقول مربع الاختيار لا تحتوي قيمًا يمكن اقتراحها."
